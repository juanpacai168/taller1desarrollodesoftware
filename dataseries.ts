...
export const series: Serie[] = [
  ...
  new Serie(3, "Game of Thrones", "HBO", 7,
    "American fantasy drama based on novels by George R. R. Martin.",
  ...
  new Serie(5, "Sherlock", "BBC", 4,
    "Modern-day version of Sherlock Holmes solving crimes in London.",
    "https://www.bbc.co.uk/programmes/b018ttws",
    "./img5.png"),

  new Serie(6, "A Very English Scandal", "BBC", 2,
    "Fact-based miniseries based on the scandal involving Jeremy Thorpe.",
